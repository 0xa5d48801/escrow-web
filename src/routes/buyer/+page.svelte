...
<div class="space-y-6">
	<h1 class="buyer-page-title">
		{t('buyer.title', language.current as any)}
	</h1>

	<!-- Filter Section -->
	<div class="card buyer-filter-section">
		<div class="filter-buttons">
			...
			>
				{t('buyer.allTrades', language.current as any)}
			</button>
...
<style>
	...
	body.dark .buyer-filter-section {
